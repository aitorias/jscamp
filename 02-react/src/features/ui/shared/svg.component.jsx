export function SVG({ height = 24, width = 24, fill = 'none', stroke = 'currentColor', strokeLinecap = 'round', strokeLinejoin = 'round', strokeWidth = 1, viewBox = '0 0 24 24', children }) {
